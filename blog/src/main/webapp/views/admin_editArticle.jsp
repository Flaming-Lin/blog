...
<%
    ...
    for(Category category : article.getCategories()){
        categoriesBuilder.append(category.getContent()).append(';');
    }
...
<form action="<%=contextPath%>/admin_editArticle" method="post">
    ...
    图片路径：<input type="file" name="uploadPic" value="<%=article.getPicUrl()%>"/><br/>
    文章分类：<input type="text" name="category" value="<%=categories%>"/><br/>
